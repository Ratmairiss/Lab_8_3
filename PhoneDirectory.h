...
public:
	...
	map <char, string> getCodesForHuffmanAlgorithm(const string& str);
	void			   encodeStr(string& str, map <char, string>& codes);
	void			   decodeStr(string& str, int initialSize, map<string, char> codes);
